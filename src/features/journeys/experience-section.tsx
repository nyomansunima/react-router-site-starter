  ...
  return (
    <section className="flex flex-col">
      <div className="flex flex-col gap-4">
        <h2 className="font-medium">Experiences: Career & contributions</h2>

        <div className="flex flex-col gap-2 bg-surface p-3 border border-border rounded-2xl transition-all duration-300 hover:-translate-y-1 cursor-pointer">
